...
// TO DO
const compareToHundred = function (num) {
    let message;

    if (num >= 100) {
        message = "that is 100 or greater";
    } else {
        message = "number is less than 100";
    }
    return message;
}
...
const quizAnswer = function (answer) {
    switch(answer){
        case "a":
...
// TO DO
const concatenateStringsArrow = (str1, str2) => `${str1} ${str2}`
